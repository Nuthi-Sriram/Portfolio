...
const Hero = () => {
  ...
  const three = <h3 className="big-heading">I build backend systems that hold up.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a className="email-link" href="mailto:sriramnuthi@gmail.com" target="_blank" rel="noreferrer">
      Contact Me!
    </a>
  );
